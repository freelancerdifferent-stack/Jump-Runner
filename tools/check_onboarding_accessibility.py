...
print('role_status=yes polite=yes atomic=yes clean_retrigger=yes stale_timer_guard=yes action_aware_jump=yes functional_dash_lesson=yes single_announce=yes storage_read_guard=yes storage_write_guard=yes replay_preserves_completion=yes')
