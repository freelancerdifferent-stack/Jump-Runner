...
print("offline=yes lifecycle_bridge=yes canvas=1 adaptive_android_viewport=yes viewport_resize_guard=yes large_screen_touch_scaling=yes crash_safe_host=yes stable_fullscreen=yes finish_guard=yes boss_readability=yes boss_core_window_fairness=yes boss_one_hit_per_pass=yes boss_reachable_core_lane=yes boss_first_run_coaching=yes boss_timing_telegraph=yes control_feedback=yes control_accessibility=yes dash_ready_feedback=yes buffered_jump_feedback=yes coyote_feedback=yes danger_telegraphs=yes checkpoint_feedback=yes impact_feedback=yes damage_accessibility=yes flow_feedback=yes flow_accessibility=yes health_accessibility=yes personal_best_feedback=yes personal_best_accessibility=yes crystal_accessibility=yes near_miss_feedback=yes landing_feedback=yes boss_phase_feedback=yes boss_hit_accessibility=yes boss_shot_telegraph=yes monetization=absent")