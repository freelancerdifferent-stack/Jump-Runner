...
if HTML.is_file():
    ...
    for token, message in (
        ...
        ('checkpoint-pace-chip.js', 'checkpoint pace chip is required'),
        ('run-split-recap.js', 'run split recap is required'),
    ...
    require("checkpointsplitrecap" in flat and "run-split-recap-row" in flat and "jumprunnerresult" in flat and "requestanimationframe(renderrunsplitrecap)" in flat, "result screen must preserve the run checkpoint split recap")
