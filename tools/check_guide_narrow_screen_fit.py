...
require("constsafe_center='calc(env(safe-area-inset-left)+(100vw-env(safe-area-inset-left)-env(safe-area-inset-right))/2)'" in flat,'guide chip center must be computed inside the usable horizontal safe area')
require('left:${safe_center}' in flat,'guide chip must use the safe-area-aware horizontal center')
...
print('viewport_bound=yes safe_area_horizontal=yes safe_area_centered=yes ellipsis=yes full_accessible_label=yes padding_safe=yes')
