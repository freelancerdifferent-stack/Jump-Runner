...
if TARGET.is_file():
    ...
    require("prefers-reduced-motion:reduce" in flat and ".split-streak-target.pop{animation:none}" in flat, "target acknowledgement must respect reduced motion")
...
print("packaged=yes persistent_target=yes consecutive_tracking=yes record_pace=yes lifecycle_reset=yes accessibility=yes reduced_motion=yes restrained=yes")
