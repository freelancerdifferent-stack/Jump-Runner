...
(()=>{
 ...
 const base=renderHealth;renderHealth=function(){const before=previous;base();if(health<before)pulse('integrity-hit');else if(health>before&&state==='play')pulse('integrity-restore');previous=health;};
 const reset=resetRun;resetRun=function(){previous=maxHealth;reset();};
})();
