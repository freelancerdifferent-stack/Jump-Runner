...
(()=>{
  ...
  resetBoss=function(){reset();shown=false;announceLatch=false;cue.classList.remove('show');cue.textContent='CORE APPROACHING · GET READY';};
})();
