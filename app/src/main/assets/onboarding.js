...
resetRun=function(){if(!onboardingDone){onboardingStage=0;shownStage=-1;}clearTimeout(tipAnnounceTimer);clearTimeout(showTip.t);tip.textContent='';tip.classList.remove('show');onboardingReset();};
