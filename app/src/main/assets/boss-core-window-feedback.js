...
(()=>{
  ...
  resetBoss=function(){reset();wasOpen=false;hpAtOpen=0;missedTimer=0;lastAction='';cue.classList.remove('show','missed');cue.setAttribute('aria-hidden','true');renderOpen();};
})();
