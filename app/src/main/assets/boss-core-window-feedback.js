...
(()=>{
  ...
  function refresh(dt){
    ...
    if(open)renderOpen();
    cue.classList.toggle('show',open||missedTimer>0);
    wasOpen=open;
  }
  ...
  resetBoss=function(){reset();wasOpen=false;hpAtOpen=0;missedTimer=0;cue.classList.remove('show','missed');renderOpen();};
})();
