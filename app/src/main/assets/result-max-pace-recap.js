...
(()=>{
 ...
 function decorateResult(){
  ...
  card.setAttribute('aria-label',record?`New maximum pace hold record: ${held.toFixed(1)} seconds. Personal best ${best.toFixed(1)} seconds.`:matched?`Maximum pace held for ${held.toFixed(1)} seconds this run, matching your ${best.toFixed(1)} second personal best.`:`Maximum pace held for ${held.toFixed(1)} seconds this run. ${gap.toFixed(1)} seconds short of your ${best.toFixed(1)} second personal best. ${progressPct} percent of your best.`);
  card.append(label,value,note,meter,meta);
