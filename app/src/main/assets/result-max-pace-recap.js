...
(()=>{
 ...
 function decorateResult(){
  ...
  const gradeLabel=document.createElement('span');gradeLabel.className='result-max-pace-grade-label';gradeLabel.textContent='PACE GRADE · '+grade;
