...
(()=>{
 ...
 function decorateResult(){
  ...
  const gradeText=document.createElement('span');gradeText.className='result-max-pace-grade '+grade.toLowerCase();gradeText.textContent='PACE GRADE · '+grade;
  meta.append(bestText,progressText);
